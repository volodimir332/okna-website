...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: "/cenik/velkoformatove-obklady", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/cenik/podlahove-topeni", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/svet-kamene", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/svet-kamene/travertin", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { url: "/sluzby/oprava-obkladu", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { url: "/ostrava/moravska-ostrava", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/ostrava/marianske-hory", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/ostrava/vyskovice", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { url: "/partneri", priority: 0.6, changeFrequency: "monthly" as const },
    ...
    { url: "/trinec", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/orlova", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/bohumin", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/novy-jicin", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/koprivnice", priority: 0.7, changeFrequency: "monthly" as const },
